        ...
        <table width="850px">
            <tr>
                <td topmargin="0"  style="height:35px;background-image:url(../../css/res/current.png);background-repeat:no-repeat;">
                   <h3 style="color:#eee; margin-top:7px; margin-left:4px;">钻井数据导入</h3>
                </td>
            </tr>
        </table>
                ...
                <td>
                    ...
                    <table border="0" cellpadding="3" cellspacing="0" style="margin-left:3px;">
                        <tr>
                            <td>
                                对应区块:
                                <asp:DropDownList ID="ddlFJQukuai" runat="server" Width="125px"></asp:DropDownList>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                对应表名:
                                <asp:DropDownList ID="ddlFJTable" runat="server">
                                    ...
                                    <asp:Listitem>完井统计表</asp:Listitem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>

<%@ Page Language="C#" AutoEventWireup="true" Inherits="system_menumanage_left_three_edit" Codebehind="left_three_edit.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>左端三级菜单修改</title>
    ...
    <div  class="mefont">
        <table style="width:100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <td  class="tdhead" style=" height: 30px">
               <h3 style="text-align:center">修 改 左 侧 三 级 菜 单</h3>
            </td>
        </table>
        <table style="width:100%" border="1" cellpadding="3" cellspacing="1" class="metable" >
            ...
            <tr>
                ...
                <td class="tdinput" style="width: 60%; height: 20px">
                    &nbsp;<asp:DropDownList ID="top_one_list" runat="server" AutoPostBack="True" 
                        Width="242px" OnSelectedIndexChanged="top_one_list_SelectedIndexChanged" TabIndex="1">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td class="tdinput" style="width: 60%; height: 20px">
                    &nbsp;<asp:DropDownList ID="left_two_list" runat="server" AutoPostBack="True" Width="242px" TabIndex="2">
                    </asp:DropDownList>
               <asp:TextBox ID="Parent_ID" runat="server" Visible="false"></asp:TextBox></td>
            </tr>
          <tr>
                <td class="tdinput" style="width:30%; height: 20px;">&nbsp;左端三级菜单名称：</td>
                <td class="tdinput" style="width: 60%; height: 20px;">
                    &nbsp;<asp:TextBox ID="txtTitle" runat="server" Width="242px" AutoPostBack="true" OnTextChanged="checkname" TabIndex="3" ></asp:TextBox>
           ...
           <tr>
                ...
                <td class="tdinput" style="width: 60%; height: 20px;">
                    &nbsp;<asp:DropDownList ID="selected_position" runat="server" Width="242px" AutoPostBack="True" AppendDataBoundItems="true" TabIndex="4">
            ...
            <tr>
                ...
                <td class="tdinput" style="width: 60%; height: 20px;">
                    &nbsp;<asp:TextBox ID="txtAuthority_Desc" runat="server" Width="242px" TabIndex="5" ></asp:TextBox> </td>
          </tr>
          <tr>
                <td class="tdinput" style="width:30%; height: 20px;">&nbsp;URL：</td>
                <td class="tdinput" style="width: 60%; height: 20px;">
                    &nbsp;<asp:TextBox ID="txtNavigateUrl" runat="server" Width="242px" TabIndex="6" ></asp:TextBox> </td>
          </tr>
          <tr>
				<td class="tdinput" style="width:30%; height: 20px;">&nbsp;排序顺序：</td>
				<td class="tdinput" style="height: 20px">
					&nbsp;<asp:TextBox id="txtOrderLevel" runat="server" Width="242px" TabIndex="7"></asp:TextBox>（请输入一个不小于零的自然数）<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" display="dynamic"
		 ...
		 <tr>
				...
				<td class="tdinput">&nbsp;<asp:TextBox id="txtRemark" runat="server" TextMode="MultiLine" Width="272px" Height="48px" TabIndex="8"></asp:TextBox></td>
		 </tr>
		 <tr>

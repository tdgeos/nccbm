<%@ Page Language="C#" AutoEventWireup="true" Theme="blue"  Inherits="system_menumanage_left_three_list" Codebehind="left_three_list.aspx.cs" %>
...
<body style="margin-top:0" >
    ...
    <div  class="mefont">
        <table style="height:400px" cellspacing="0" cellpadding="3" width="100%" border="0">
					<tr align="center" >
						<td  colspan="4"  style="width:100%;background-color:C3CFDF; height: 25px;" >
					...
					<tr align="center" valign="top" style="height:80%; width:100%"  >
					    <td colspan="4" style="height: 80%">
                            <asp:GridView ID="GVLeftThreeList" runat="server" AllowPaging="True" AllowSorting="True"
                                AutoGenerateColumns="False" DataKeyNames="T_ID" SkinID="Blue1"
                                Width="100%" OnSelectedIndexChanged="GVLeftThreeList_SelectedIndexChanged" OnRowDataBound="GVLeftThreeList_RowDataBound" 
                                DataSourceID="GridviewSqlDataSource" OnRowDeleting="GVLeftThreeList_RowDeleting">
                                <Columns>
                                    <asp:BoundField DataField="T_ID" HeaderText="序号" ReadOnly="True" SortExpression="T_ID" Visible="False" />
                                    <asp:BoundField DataField="Title" HeaderText="左侧三级菜单" SortExpression="Title" />
        ...
        SelectCommand="SELECT T_ID, Title, Parent_ID, Authority_Level, OrderLevel, NavigateUrl, Target, Authority_Desc, Authority_Status, Remark FROM T_System_APPLICATION WHERE (Authority_Level = @Authority_Level) AND (Parent_ID = @Parent_ID) order by OrderLevel" 

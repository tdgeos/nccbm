<%@ Page Language="C#" AutoEventWireup="true" Inherits="system_menumanage_top_one_edit" Codebehind="top_one_edit.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>顶端一级菜单修改</title>
    ...
    <div  class="mefont">
        <table style="width:100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <td  class="tdhead" style=" height: 30px">
               <h3 style="text-align:center">修 改 顶 端 一 级 菜 单</h3>
            </td>
        </table>
        <table style="width:100%" border="1" cellpadding="3" cellspacing="1" class="metable" > 
			 ...
			 <tr >
				...
				<tr>
					...
					<td class="tdinput">
							&nbsp;<asp:TextBox id="txtRemark" runat="server" TextMode="MultiLine" Width="272px" Height="48px" TabIndex="4"></asp:TextBox></td>
				</tr>
				<tr>
					<td style="height:30px" align="center" class="tdinput"><span class="p20"> </span></td>
					<td class="tdinput">
						<asp:Button CssClass="button" ForeColor="White" Font-Size="Small" id="btnAdd" runat="server" Text="确定 >>" onclick="btnAdd_Click" TabIndex="5"></asp:Button></td>
				</tr>       
		</table>
    </div>
    </form>

<%@ Page Language="C#" AutoEventWireup="true" Inherits="system_menumanage_left_two_add" Codebehind="left_two_add.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>添加左侧二级级菜单</title>
    ...
    <div  class="mefont">
        <table style="width:100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <td  class="tdhead" style=" height: 30px">
               <h3 style="text-align:center">添 加 左 侧 二 级 菜 单</h3>
            </td>
        </table>
        <table style="width:100%" border="1" cellpadding="3" cellspacing="1" class="metable" >
          <tr>
                ...
                <td class="tdinput" style="width: 60%; height: 20px;">
                    &nbsp;<asp:DropDownList ID="top_one_list" runat="server"  Width="242px" DataSourceID="SqlDataSource1" DataTextField="Title" DataValueField="T_ID" TabIndex="1">
                    </asp:DropDownList></td>
          </tr>         
           <tr>
                <td class="tdinput" style="width:30%; height: 20px;">&nbsp;左侧二级菜单名称：</td>
                <td class="tdinput" style="width: 60%; height: 20px;">
                    &nbsp;<asp:TextBox ID="txtTitle" runat="server" Width="242px" AutoPostBack="true" OnTextChanged="checkname" TabIndex="2" ></asp:TextBox><asp:RequiredFieldValidator id="validor1" runat="server" controltovalidate="txtTitle" text="必填项目"/>
                    </td>
          </tr>     
                    <tr>
          ...
          <tr>
				...
				<tr >
					...
					<td class="tdinput" style="height: 36px">
						&nbsp;<asp:TextBox id="txtOrderLevel" runat="server" Width="242px" TabIndex="5"></asp:TextBox>（请输入一个不小于零的自然数）<asp:RegularExpressionValidator
                            ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtOrderLevel"
                            Display="dynamic" ErrorMessage="输入不正确,请重新输入!" ValidationExpression="^\+?[1-9][0-9]*$"></asp:RegularExpressionValidator>
                    </td>
				</tr>
				<tr class="tdinput">
					<td class="tdinput" style="width:30%; height: 20px;">&nbsp;备注：</td>
					<td class="tdinput"><font face="宋体">
							&nbsp;<asp:TextBox id="txtRemark" runat="server" TextMode="MultiLine" Width="272px" Height="48px" TabIndex="6"></asp:TextBox></font></td>
				</tr>
				<tr>
					<td style="height:30px" align="center" class="tdinput"><span class="p20"> </span></td>
					<td class="tdinput">
						<asp:Button CssClass="button" ForeColor="White" Font-Size="Small" id="btnAdd" runat="server" Text="确定 >>" onclick="btnAdd_Click" TabIndex="7"></asp:Button></td>
				</tr>       
				</table>

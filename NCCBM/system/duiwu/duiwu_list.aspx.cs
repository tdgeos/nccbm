...
{
    public partial class duiwu_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (tbName.Text.Trim() != "")
                {
                    strSQL += "and name like '%" + tbName.Text.Trim() + "%'";
                }
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("duiwu_edit.aspx?ID=" + id + "&iPage=" + iPage + "&strName=" + tbName.Text);
            }

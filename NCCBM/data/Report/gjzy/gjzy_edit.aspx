<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gjzy_edit.aspx.cs" Inherits="NCCBM.data.Report.gjzy.gjzy_edit" %>
    ...
    <table width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">修 改 固 井 作 业 数 据</h3></td>
          </tr> 
    </table>
    <table border="1" cellpadding="3" cellspacing="1" class="metable" width="850px" >
        ...
        <tr> 
            ...
            <td align="left"colspan="5">                                                        
                <asp:TextBox ID="TB_yichang" runat="server" Height="100px" Width="740px" TextMode="MultiLine"></asp:TextBox>
            </td>      
        </tr>
        <tr> 
            <td>处理措施</td> 

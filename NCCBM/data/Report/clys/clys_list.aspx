<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clys_list.aspx.cs" Inherits="NCCBM.data.Report.clys.clys_list" %>
    ...
    <form id="form1" runat="server">
        <asp:GridView ID="GridView2" runat="server" Width="840px"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="shigongduiwu" HeaderText="施工队伍" SortExpression="shigongduiwu" ItemStyle-Width="80px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="jiandu" HeaderText="监督" SortExpression="jiandu" ItemStyle-Width="80px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="yongshuicengwei" HeaderText="涌水层位" SortExpression="loushicengwei" ItemStyle-Width="60px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="yongshuiliang" HeaderText="涌水量" SortExpression="loushiliang" ItemStyle-Width="100px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="cuoshi" HeaderText="处理措施" SortExpression="cuoshi" ItemStyle-Width="100px" ItemStyle-Font-Size="Small"/>

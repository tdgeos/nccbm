<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clys_add.aspx.cs" Inherits="NCCBM.data.Report.clys.clys_add" %>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">增 加 处 理 涌 水 数 据</h3></td>
          </tr> 
   </table>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clys_edit.aspx.cs" Inherits="NCCBM.data.Report.clys.clys_edit" %>
...
<body>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">修 改 处 理 涌 水 数 据</h3></td>
          </tr> 
   </table>
    <table border="1" cellpadding="3" cellspacing="1" class="metable" Width="850px" >
        ...
        <tr>   
            ...
            <td>涌水层位</td> 
            <td>                                                        
                <asp:TextBox ID="TB_yongshuicengwei" runat="server" CssClass="inputwidth"></asp:TextBox>
            </td>      
        </tr>
        <tr>
            ...
            <td>涌水量</td> 
            <td>                                                        
                <asp:TextBox ID="TB_yongshuiliang" runat="server" CssClass="inputwidth"></asp:TextBox>
            </td> 
        </tr>      
        <tr> 
            <td>处理措施</td> 
        ...
        <tr> 
            <td>处理结果</td>
            <td align="left"colspan="5">                                                       
                <asp:TextBox ID="TB_jieguo" runat="server" Height="100px" Width="740px" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>     
        <tr> 

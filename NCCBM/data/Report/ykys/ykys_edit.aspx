<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ykys_edit.aspx.cs" Inherits="NCCBM.data.Report.ykys.ykys_edit" %>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">修 改 一 开 验 收 数 据</h3></td>
          </tr> 
   </table>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ykys_list.aspx.cs" Inherits="NCCBM.data.Report.ykys.ykys_list" %>
    ...
    <form id="form1" runat="server">
        <asp:GridView ID="GridView2" runat="server" Width="100%"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="shigongduiwu" HeaderText="施工队伍" SortExpression="shigongduiwu" ItemStyle-Width="60px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="jiandu" HeaderText="监督" SortExpression="jiandu" ItemStyle-Width="50px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="yikaishijian" HeaderText="一开验收时间" SortExpression="yikaishijian" ItemStyle-Width="80px" ItemStyle-Font-Size="Small" DataFormatString="{0:yyyy-MM-dd}"/>
                <asp:BoundField DataField="erkaishijian" HeaderText="二开验收时间" SortExpression="erkaishijian" ItemStyle-Width="80px" ItemStyle-Font-Size="Small" DataFormatString="{0:yyyy-MM-dd}"/>
                <asp:BoundField DataField="yinsu" HeaderText="不合格因素" SortExpression="yinsu" ItemStyle-Width="150px" ItemStyle-Font-Size="Small"/>

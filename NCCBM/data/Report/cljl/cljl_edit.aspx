<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cljl_edit.aspx.cs" Inherits="NCCBM.data.Report.cljl.cljl_edit" %>
...
<body>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">修 改 处 理 井 漏 数 据</h3></td>
          </tr> 
   </table>
    <table border="1" cellpadding="3" cellspacing="1" class="metable" Width="850px" >
        ...
        <tr>   
            ...
            <td>漏失层位</td> 
            <td>                                                        
                <asp:TextBox ID="TB_loushicengwei" runat="server" CssClass="inputwidth"></asp:TextBox>
            </td>      
        </tr>
        <tr>
            ...
            <td>漏失量</td> 
            <td>                                                        
                <asp:TextBox ID="TB_loushiliang" runat="server" CssClass="inputwidth"></asp:TextBox>
            </td> 
        </tr>      
        <tr> 
            <td>处理措施</td> 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cljl_list.aspx.cs" Inherits="NCCBM.data.Report.cljl.cljl_list" %>
    ...
    <form id="form1" runat="server">
        <asp:GridView ID="GridView2" runat="server" Width="840px"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="jinghao" HeaderText="井号" SortExpression="jinghao" ItemStyle-Width="100px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="shigongduiwu" HeaderText="施工队伍" SortExpression="shigongduiwu" ItemStyle-Width="100px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="jiandu" HeaderText="监督" SortExpression="jiandu" ItemStyle-Width="80px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="loushicengwei" HeaderText="漏失层位" SortExpression="loushicengwei" ItemStyle-Width="60px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="loushiliang" HeaderText="漏失量" SortExpression="loushiliang" ItemStyle-Width="120px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="cuoshi" HeaderText="处理措施" SortExpression="cuoshi" ItemStyle-Width="120px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="jieguo" HeaderText="处理结果" SortExpression="jieguo" ItemStyle-Width="60px" ItemStyle-Font-Size="Small"/>
                <asp:BoundField DataField="beizhu" HeaderText="备注" SortExpression="beizhu" ItemStyle-Width="40px" ItemStyle-Font-Size="Small"/>
                

                <asp:TemplateField HeaderText="操作" ShowHeader="False" Visible="False" ItemStyle-Width="40px" ItemStyle-Font-Size="Small">
                    <ItemTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xtg_add.aspx.cs" Inherits="NCCBM.data.Report.xtg.xtg_add" %>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">添 加 下 套 管 作 业 数 据</h3></td>
          </tr> 
   </table>

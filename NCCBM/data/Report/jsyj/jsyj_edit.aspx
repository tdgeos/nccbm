<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jsyj_edit.aspx.cs" Inherits="NCCBM.data.Report.jsyj.jsyj_edit" %>
        ...
        <table width="850px" border="0" cellpadding="0" cellspacing="0" >
          <tr >                
            <td style=" height: 30px">
              <h3 style="text-align:center">修改技术研究及其他工作数据</h3></td>
          </tr> 
        </table>
        ...
        <table>
            <tr>
                <td align="center" style="width:850px;">
                    ...
                    &nbsp;&nbsp;<asp:Button CssClass="button-query" ForeColor="White" Font-Size="Medium" ID="btnBack" runat="server" Text="返回" onclick="btnBack_Click1"/>
                </td>
            </tr>      
        </table>
    </form>

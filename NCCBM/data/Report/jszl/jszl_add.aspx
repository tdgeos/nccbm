<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jszl_add.aspx.cs" Inherits="NCCBM.data.Report.jszl.jszl_add" %>
    ...
    <table width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">添 加 井 身 质 量 数 据</h3></td>
          </tr> 
   </table>

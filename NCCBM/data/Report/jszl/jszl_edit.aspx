<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jszl_edit.aspx.cs" Inherits="NCCBM.data.Report.jszl.jszl_edit" %>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">修 改 井 身 质 量 数 据</h3></td>
          </tr> 
   </table>

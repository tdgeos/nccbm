<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jszl_list.aspx.cs" Inherits="NCCBM.data.Report.jszl.jszl_list" %>
    ...
    <form id="form1" runat="server">
        <asp:GridView ID="GridView2" runat="server" Width="840px"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="yinsu" HeaderText="超标因素" SortExpression="yinsu" ItemStyle-Width="150px" ItemStyle-Font-Size="Small"/>

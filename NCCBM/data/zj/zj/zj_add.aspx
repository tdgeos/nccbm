<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zj_add.aspx.cs" Inherits="NCCBM.data.zj.zj.zj_add" %>
...
<body>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">增 加 钻 进 数 据</h3></td>
          </tr> 
   </table>
    <table border="1" cellpadding="3" cellspacing="1" class="metable" width="850px" >
        <tr>
            ...
            <td>                                                          
                <asp:TextBox ID="TB_fuzejiandu" CssClass="inputwidth" runat="server"></asp:TextBox>
            </td>
             <td style="width:100px;">队号</td> 
            <td>                                                        
                <asp:TextBox ID="TB_duihao" CssClass="inputwidth" runat="server"></asp:TextBox>
            </td>
             <td style="width:100px;">井号</td> 
            <td>                                                         
                <asp:TextBox ID="TB_jinghao" CssClass="inputwidth" runat="server"></asp:TextBox>
            </td>   
        </tr>
        <tr>   
            <td>开钻日期</td> 

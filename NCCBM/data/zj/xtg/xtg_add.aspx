<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xtg_add.aspx.cs" Inherits="NCCBM.data.zj.xtg.xtg_add" %>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">增 加 下 套 管 数 据</h3></td>
          </tr> 
   </table>
    <table border="1" cellpadding="3" cellspacing="1" class="metable" Width="850px" >
        ...
        <tr>  
         ...
         <tr>
            ...
            <td>浮箍、浮鞋检查</td> 
            <td>                                                         
                <asp:TextBox ID="TB_fukuang" runat="server" CssClass="inputwidth"></asp:TextBox>
            </td>  
        </tr>
        <tr>  
            <td>套管数据表是否按要求填写</td> 
        ...
        <tr> 
            ...
            <td align="left"colspan="5">
                <asp:TextBox ID="TB_beizhu" runat="server" Height="100px" Width="740px" TabIndex="14" TextMode="MultiLine"></asp:TextBox>                
            </td>
        </tr>
        <tr>  

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sk_add.aspx.cs" Inherits="NCCBM.data.yl.sk.sk_add" %>
...
<body>
    <form id="form1" runat="server">    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">增 加 射 孔 数 据</h3></td>
          </tr> 
   </table>

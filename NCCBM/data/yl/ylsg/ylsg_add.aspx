<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ylsg_add.aspx.cs" Inherits="NCCBM.data.yl.ylsg.ylsg_add" %>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">增 加 压 裂 施 工 数 据</h3></td>
          </tr> 
    </table>
    <table border="1" cellpadding="3" cellspacing="1" class="metable" Width="850px" height="600px">
        <tr>

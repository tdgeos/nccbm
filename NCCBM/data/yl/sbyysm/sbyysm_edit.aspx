<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sbyysm_edit.aspx.cs" Inherits="NCCBM.data.yl.sbyysm.sbyysm_edit" %>
    ...
    <table Width="850px" border="0" class="metable" cellpadding="0" cellspacing="0" >
          <tr >                
            <td  class="tdhead" style=" height: 30px">
              <h3 style="text-align:center">修 改 失 败 原 因 说 明 数 据</h3></td>
          </tr> 
    </table>

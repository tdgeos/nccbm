...
{
    public partial class Tongji_Xtg : System.Web.UI.Page
    {
        ...
        private void getData(string begin, string end)
        {
            ...
            if (ddl_zj_qukuai.Text != "全部")
            {
                ...
                string sqlTemp = "select place,jinghao from Xls_Zj_Rbb_Xtg where riqi between '" + begin + "' and '" + end + "' and place='" + qk + "'";
                ...
                sqlTemp = "select qukuai,jinghao from Report_xtgzuoye where lururiqi between '" + begin + "' and '" + end + "' and qukuai='" + qk + "'";
            ...
            else
            {
                ...
                sqlTemp = "select qukuai,jinghao from Report_xtgzuoye where lururiqi between '" + begin + "' and '" + end + "'";
                dtTemp = DataBaseHelper.query(sqlTemp);
                if (dtTemp.Rows.Count > 0)
                {
                    for (int i = 0; i < dtTemp.Rows.Count; i++)
        ...
        private void getImageData()
        {
            ...
            if (rbXian.Checked)
            {
                if (ddl_zj_qukuai.SelectedItem.Text == "全部")
                {
                    ...
                    data += "qb,(" + riqi + "),1,";
                    data += "韩城;临汾;忻州,";
                    data += "下套管监督井数;" + sshc[0] + ";" + sslf[0] + ";" + ssxz[0] + "$";
                ...
                img.Attributes["src"] = "chartXtgzy.aspx?data=" + data;
            }

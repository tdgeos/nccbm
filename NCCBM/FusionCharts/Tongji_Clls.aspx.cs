...
{
    public partial class Tongji_Clls : System.Web.UI.Page
    {
        ...
        private void getData(string begin, string end)
        {
            ...
            if (ddl_zj_qukuai.Text != "全部")
            {
                ...
                string sqlTemp = "select qukuai,jinghao,jieguo from Report_jinglou where lururiqi between '" + begin + "' and '" + end + "' and qukuai='" + qk + "'";
            ...
            {
                string sqlTemp = "select qukuai,jinghao,jieguo from Report_jinglou where lururiqi between '" + begin + "' and '" + end + "'";
                DataTable dtTemp = DataBaseHelper.query(sqlTemp);
                naQk[0] = dtTemp.Rows.Count;
                if (dtTemp.Rows.Count > 0)
                {
        ...
        private void getImageData()
        {
            ...
            if (rbXian.Checked)
            {
                ...
                if (ddl_zj_qukuai.SelectedItem.Text == "全部")
                {
                    ...
                    data += "qb,(" + riqi + "),1,";
                    data += "韩城;临汾;忻州,";
                    data += "漏失井数;" + sshc[0] + ";" + sslf[0] + ";" + ssxz[0] + "$";
                    data += "堵漏成功井数;" + sshc[1] + ";" + sslf[1] + ";" + ssxz[1];
                }
                else
                {
                    string s = lblData.Text;
                ...
                img.Attributes["src"] = "chartJlqk.aspx?data=" + data;
            }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tongji_Gkfx.aspx.cs" Inherits="NCCBM.FusionCharts.Tongji_Gkfx" %>
...
<body>
    <form id="form1" runat="server">
        <table width="850px">
            <tr>
                <td style="height:35px;background-image:url(../../css/res/current.png);background-repeat:no-repeat;">
                   <h3 style="color:#eee; margin-top:7px; margin-left:10px;">工况分析</h3>
                </td>
            </tr>
        </table>
        ...
        <table cellspacing="5">
            <tr>
                <td>
                    <asp:Label ID="lblTable" runat="server" Text="工况分析" Width="400px" style="text-align:center;"></asp:Label>
                    <br />
                ...
                <td>
                    <div style="width:400px; height:300px;float:left;">
                        <asp:GridView ID="gv" runat="server" Width="400px" Height="280px" AutoGenerateColumns="False">
                            <Columns>
                                <asp:BoundField DataField="zugongyinsu" HeaderText="阻工因素" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="hancheng" HeaderText="韩城" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="linfen" HeaderText="临汾" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="xinzhou" HeaderText="忻州" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                            </Columns>
                        </asp:GridView>
                    </div>
                </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tongji_Clls.aspx.cs" Inherits="NCCBM.FusionCharts.Tongji_Clls" %>
...
<body>
    <form id="form1" runat="server">
        <table width="850px">
            <tr>
                <td style="height:35px;background-image:url(../../css/res/current.png);background-repeat:no-repeat;">
                   <h3 style="color:#eee; margin-top:7px; margin-left:10px;">处理漏失</h3>
                </td>
            </tr>
        </table>
        ...
        <table cellspacing="5">
            <tr>
                <td>
                    <asp:Label ID="lblTable" runat="server" Text="处理漏失" Width="400px" style="text-align:center;"></asp:Label>
                    <br />
                    ...
                    <div style="width:400px; height:300px;float:left;">
                        <asp:GridView ID="gv" runat="server" Width="400px" Height="280px" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:BoundField DataField="loushi" HeaderText="漏失井数" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="chenggong" HeaderText="堵漏成功井数" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                            </Columns>
                        </asp:GridView>
                    </div>
                </td>

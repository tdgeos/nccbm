<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tongji_Xtg.aspx.cs" Inherits="NCCBM.FusionCharts.Tongji_Xtg" %>
...
<body>
    <form id="form1" runat="server">
        <table width="850px">
            <tr>
                <td style="height:35px;background-image:url(../../css/res/current.png);background-repeat:no-repeat;">
                   <h3 style="color:#eee; margin-top:7px; margin-left:10px;">下套管作业</h3>
                </td>
            </tr>
        </table>
        ...
        <table cellspacing="5">
            <tr>
                <td>
                    <asp:Label ID="lblTable" runat="server" Text="下套管作业" Width="400px" style="text-align:center;"></asp:Label>
                    <br />
                    ...
                    <div style="width:400px; height:300px;float:left;">
                        <asp:GridView ID="gv" runat="server" Width="400px" Height="280px" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:BoundField DataField="xtg" HeaderText="下套管监督井数" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="yichang" HeaderText="异常施工井数" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                            </Columns>
                        </asp:GridView>
                    </div>
                </td>

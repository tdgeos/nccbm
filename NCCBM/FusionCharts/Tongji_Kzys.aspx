<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tongji_Kzys.aspx.cs" Inherits="NCCBM.FusionCharts.Tongji_Kzys" %>
        ...
        <table width="850px">
            <tr>
                <td style="height:35px;background-image:url(../../css/res/current.png);background-repeat:no-repeat;">
                   <h3 style="color:#eee; margin-top:7px; margin-left:10px;">开钻验收</h3>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td>
                    <div style="width:400px;float:left;">
                        <asp:Label ID="lblTable" runat="server" Text="开钻验收" Width="400px" style="text-align:center;"></asp:Label>
                        <br />
                    ...
                    <div style="width:400px; height:300px;float:left;">
                        <asp:GridView ID="gv" runat="server" Width="400px" Height="280px" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:BoundField DataField="yikai" HeaderText="一开验收总数" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="yikaihege" HeaderText="一开合格数量" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="yikaibu" HeaderText="一开不合格数量" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="erkai" HeaderText="二开验收总数" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="erkaihege" HeaderText="二开合格数量" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:BoundField DataField="erkaibu" HeaderText="二开不合格数量" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                            </Columns>
                        </asp:GridView>
                    </div>
                </td>
